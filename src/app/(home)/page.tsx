import { MedicalSpecialization } from "@/components/MedicalSpecialization";
...
export default function HomePage() {
  return (
    <main className="flex flex-col gap-10">
      ...
      <HighlightWeek />
      <ProfessionalSection Specialization="Acunpulturistas" />
      <ProfessionalSection Specialization="Reikianos" />
    </main>
  );
}
